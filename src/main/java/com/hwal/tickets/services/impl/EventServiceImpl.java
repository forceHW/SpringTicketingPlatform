package com.hwal.tickets.services.impl;
...
import com.hwal.tickets.exceptions.UserNotFoundException;
import com.hwal.tickets.repositories.EventRepository;
...
public class EventServiceImpl implements EventService {
    ...
    public Event updateEventForOrganizer(UUID organizerId, UUID id, UpdateEventRequest event) {
        ...
        Event existingEvent = eventRepository.findByIdAndOrganizerId(id, organizerId)
                .orElseThrow(() -> new EventNotFoundException(String.format("Event with ID '%s' dies bit exist", id)));
    ...
    @Override
    public Optional<Event> getPublishedEventForAttendee(UUID id) {
